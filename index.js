...
const app = express();
const uri = "mongodb+srv://ray:anakmama121@whatsapp.kz693.mongodb.net/?retryWrites=true&w=majority&appName=Whatsapp";
...
async function startServer() {
  ...
  if (isPortAvailable) {
    ...
    app.get('/users', async (req, res) => {
      try {
        const usersCollection = client.db("whatsapp").collection("users");
